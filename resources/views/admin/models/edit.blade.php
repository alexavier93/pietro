...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.models.index') }}">Modelos</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.models.update', ['model' => $model->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $model->name }}">
                                @error('name')
